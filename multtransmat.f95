program multtransmat
implicit none
!checks if transpose of two matrices multiplied equals transpose of
!the matrices then multiplied
...
ra3 = transpose(matmul(ra1,ra2))
print *, 'Matmul of ra1 and ra2 then transpose'
call outputra(size,ra3)
ra3 = matmul((transpose(ra1)),(transpose(ra2)))
print *, 'transpose of ra1 and ra2 then matmul'
call outputra(size,ra3)

deallocate(ra1,ra2,ra3)

end program multtransmat
